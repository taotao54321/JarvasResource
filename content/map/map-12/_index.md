...
<a href="#event-12-231">
<use href="#svg-asset-event" x="96" y="1848"><title>(12, 231): イベント 0x56</title></use>
</a>
<a href="#event-19-173">
<use href="#svg-asset-event" x="152" y="1384"><title>(19, 173): イベント 0xEF</title></use>
</a>
<a href="#event-20-202">
<use href="#svg-asset-event" x="160" y="1616"><title>(20, 202): イベント 0xB5</title></use>
</a>
<a href="#event-20-231">
...
<a href="#event-40-123">
<use href="#svg-asset-event" x="320" y="984"><title>(40, 123): イベント 0x25</title></use>
</a>
<a href="#event-40-183">
...
<a href="#event-52-71">
<use href="#svg-asset-event" x="416" y="568"><title>(52, 71): イベント 0x19</title></use>
</a>
<a href="#event-52-215">
...
<a href="#event-68-71">
<use href="#svg-asset-event" x="544" y="568"><title>(68, 71): イベント 0x1B</title></use>
</a>
<a href="#event-68-135">
<use href="#svg-asset-event" x="544" y="1080"><title>(68, 135): イベント 0x29</title></use>
</a>
<a href="#event-68-219">
<use href="#svg-asset-event" x="544" y="1752"><title>(68, 219): イベント 0x54</title></use>
</a>
<a href="#event-72-27">
<use href="#svg-asset-event" x="576" y="216"><title>(72, 27): イベント 0x56</title></use>
</a>
<a href="#event-72-55">
...
<use href="#svg-asset-event" x="1440" y="1432"><title>(180, 179): イベント 0x56</title></use>
</a>
...
<use href="#svg-asset-event" x="1856" y="1720"><title>(232, 215): イベント 0x54</title></use>
</a>
<a href="#event-236-23">
<use href="#svg-asset-event" x="1888" y="184"><title>(236, 23): イベント 0x56</title></use>
</a>
<a href="#event-236-59">
...
<a href="#dst-169-66">
<use href="#svg-asset-destination" x="1352" y="528"><title>(169, 66): ワープ先 0x03</title></use>
</a>
<a href="#dst-145-146">
...
<a href="#dst-117-242">
<use href="#svg-asset-destination" x="936" y="1936"><title>(117, 242): ワープ先 0x0F</title></use>
</a>
<a href="#dst-41-144">
<use href="#svg-asset-destination" x="328" y="1152"><title>(41, 144): ワープ先 0x13</title></use>
</a>
<a href="#dst-217-178">
...
<a href="#dst-67-74">
<use href="#svg-asset-destination" x="536" y="592"><title>(67, 74): ワープ先 0x1C</title></use>
</a>
<a href="#dst-71-58">
...
<a href="#dst-39-126">
<use href="#svg-asset-destination" x="312" y="1008"><title>(39, 126): ワープ先 0x26</title></use>
</a>
<a href="#dst-83-126">
<use href="#svg-asset-destination" x="664" y="1008"><title>(83, 126): ワープ先 0x28</title></use>
</a>
<a href="#dst-67-138">
<use href="#svg-asset-destination" x="536" y="1104"><title>(67, 138): ワープ先 0x2A</title></use>
</a>
<a href="#dst-39-186">
...
### (12, 231): イベント 0x56:  {#event-12-231}

### (19, 173): イベント 0xEF:  {#event-19-173}

### (20, 202): イベント 0xB5:  {#event-20-202}
...
### (68, 71): イベント 0x1B:  {#event-68-71}

### (68, 135): イベント 0x29:  {#event-68-135}

### (68, 219): イベント 0x54:  {#event-68-219}

### (72, 27): イベント 0x56:  {#event-72-27}
...
### (180, 179): イベント 0x56:  {#event-180-179}
...
### (232, 215): イベント 0x54:  {#event-232-215}

### (236, 23): イベント 0x56:  {#event-236-23}
...
### (39, 126): ワープ先 0x26:  {#dst-39-126}

### (39, 186): ワープ先 0x2C:  {#dst-39-186}

### (41, 144): ワープ先 0x13:  {#dst-41-144}

### (41, 170): ワープ先 0x6B:  {#dst-41-170}

### (43, 218): ワープ先 0x2E:  {#dst-43-218}

### (51, 74): ワープ先 0x1A:  {#dst-51-74}

### (53, 242): ワープ先 0x0B:  {#dst-53-242}
...
### (67, 138): ワープ先 0x2A:  {#dst-67-138}

### (67, 74): ワープ先 0x1C:  {#dst-67-74}
