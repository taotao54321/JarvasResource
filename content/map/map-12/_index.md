...
<a href="#event-36-215">
<use href="#svg-asset-event" x="288" y="1720"><title>(36, 215): イベント 0x54: パタンの町の初心の家入口</title></use>
</a>
<a href="#event-40-123">
...
<a href="#event-68-219">
<use href="#svg-asset-event" x="544" y="1752"><title>(68, 219): イベント 0x54: パタンの町の初心の家入口</title></use>
</a>
<a href="#event-72-27">
...
<a href="#event-92-191">
<use href="#svg-asset-event" x="736" y="1528"><title>(92, 191): イベント 0x54: ラモッサの町の初心の家入口</title></use>
</a>
...
<use href="#svg-asset-event" x="1216" y="856"><title>(152, 107): イベント 0x54: ペイチンの町の初心の家入口</title></use>
</a>
...
<use href="#svg-asset-event" x="1344" y="1528"><title>(168, 191): イベント 0x54: ザイドタウンの町の初心の家入口</title></use>
</a>
<a href="#event-170-69">
<use href="#svg-asset-event" x="1360" y="552"><title>(170, 69): イベント 0x04: アドニスの町: エウロン西地方 (181, 162) へ</title></use>
</a>
<a href="#event-172-219">
<use href="#svg-asset-event" x="1376" y="1752"><title>(172, 219): イベント 0x23: ザイドタウンの町の遠隔武器屋入口</title></use>
</a>
<a href="#event-180-179">
<use href="#svg-asset-event" x="1440" y="1432"><title>(180, 179): イベント 0x56: ザイドタウンの町の船小屋 (ラタニア北地方 イスパ島 (192, 146) へ)</title></use>
</a>
<a href="#event-180-207">
<use href="#svg-asset-event" x="1440" y="1656"><title>(180, 207): イベント 0x54: ザイドタウンの町の初心の家入口</title></use>
</a>
<a href="#event-193-53">
...
<use href="#svg-asset-event" x="1824" y="1336"><title>(228, 167): イベント 0x54: パントーンの町の初心の家入口</title></use>
</a>
<a href="#event-228-231">
<use href="#svg-asset-event" x="1824" y="1848"><title>(228, 231): イベント 0x54: ラモンの町の初心の家入口</title></use>
</a>
<a href="#event-232-215">
<use href="#svg-asset-event" x="1856" y="1720"><title>(232, 215): イベント 0x54: ラモンの町の初心の家入口</title></use>
</a>
<a href="#event-236-23">
...
<a href="#dst-53-242">
<use href="#svg-asset-destination" x="424" y="1936"><title>(53, 242): ワープ先 0x0B: パタンの町の入口</title></use>
</a>
<a href="#dst-117-242">
<use href="#svg-asset-destination" x="936" y="1936"><title>(117, 242): ワープ先 0x0F: ラモッサの町の入口</title></use>
</a>
<a href="#dst-41-144">
...
<a href="#dst-51-74">
<use href="#svg-asset-destination" x="408" y="592"><title>(51, 74): ワープ先 0x1A: ブルガの町の近接武器屋手前</title></use>
</a>
<a href="#dst-67-74">
...
<a href="#dst-171-222">
<use href="#svg-asset-destination" x="1368" y="1776"><title>(171, 222): ワープ先 0x24: ザイドタウンの町の遠隔武器屋手前</title></use>
</a>
<a href="#dst-39-126">
<use href="#svg-asset-destination" x="312" y="1008"><title>(39, 126): ワープ先 0x26: アネイデアの町の占い屋手前</title></use>
</a>
<a href="#dst-83-126">
<use href="#svg-asset-destination" x="664" y="1008"><title>(83, 126): ワープ先 0x28: アネイデアの町のクエスト屋手前</title></use>
</a>
<a href="#dst-67-138">
...
<a href="#dst-27-234">
<use href="#svg-asset-destination" x="216" y="1872"><title>(27, 234): ワープ先 0x32: パタンの町の近接武器屋手前</title></use>
</a>
<a href="#dst-203-162">
...
### (152, 107): イベント 0x54: ペイチンの町の[初心の家](@/map/map-13b/_index.md#dst-111-211)入口 {#event-152-107}
...
### (228, 167): イベント 0x54: パントーンの町の[初心の家](@/map/map-13b/_index.md#dst-111-211)入口 {#event-228-167}
...
### (68, 219): イベント 0x54: パタンの町の[初心の家](@/map/map-13b/_index.md#dst-111-211)入口 {#event-68-219}
...
### (36, 215): イベント 0x54: パタンの町の[初心の家](@/map/map-13b/_index.md#dst-111-211)入口 {#event-36-215}
...
### (92, 191): イベント 0x54: ラモッサの町の[初心の家](@/map/map-13b/_index.md#dst-111-211)入口 {#event-92-191}
...
### (180, 207): イベント 0x54: ザイドタウンの町の[初心の家](@/map/map-13b/_index.md#dst-111-211)入口 {#event-180-207}

### (168, 191): イベント 0x54: ザイドタウンの町の[初心の家](@/map/map-13b/_index.md#dst-111-211)入口 {#event-168-191}
...
### (228, 231): イベント 0x54: ラモンの町の[初心の家](@/map/map-13b/_index.md#dst-111-211)入口 {#event-228-231}

### (232, 215): イベント 0x54: ラモンの町の[初心の家](@/map/map-13b/_index.md#dst-111-211)入口 {#event-232-215}
...
### (67, 74): ワープ先 0x1C: [ブルガの町の防具屋](@/map/map-13b/_index.md#dst-143-147)手前 {#dst-67-74}
